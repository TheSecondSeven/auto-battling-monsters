...
<?php echo $this->Form->create('Ultimate'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Ultimate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ultimate.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Ultimate.id')))); ?></li>
