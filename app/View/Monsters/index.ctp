<div class="monsters index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('dexterity'); ?></th>
			<th><?php echo $this->Paginator->sort('intelligence'); ?></th>
			<th><?php echo $this->Paginator->sort('luck'); ?></th>
			<th><?php echo $this->Paginator->sort('vitality'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($monster['Monster']['strength']); ?>&nbsp;</td>
		<td><?php echo h($monster['Monster']['agility']); ?>&nbsp;</td>
		<td><?php echo h($monster['Monster']['dexterity']); ?>&nbsp;</td>
		<td><?php echo h($monster['Monster']['intelligence']); ?>&nbsp;</td>
		<td><?php echo h($monster['Monster']['luck']); ?>&nbsp;</td>
		<td><?php echo h($monster['Monster']['vitality']); ?>&nbsp;</td>
		<td>
