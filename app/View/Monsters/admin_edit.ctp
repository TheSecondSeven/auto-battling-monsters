...
<?php echo $this->Form->create('Monster'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Monster'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Monster.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Monster.id')))); ?></li>
