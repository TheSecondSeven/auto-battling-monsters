<div class="skills index">
	...
	<tr>
		...
		<td><?php echo h($skill['Skill']['value']); ?>&nbsp;</td>
		...
		<td><?php echo h($skill['Skill']['cast_time']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['down_time']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $skill['Skill']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('controller' => 'skill_effects', 'action' => 'edit_skill', $skill['Skill']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $skill['Skill']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $skill['Skill']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
