    ...
    protected function _getEffectVerbose() {
        if(in_array($this->effect, ['Physical Damage','Magical Damage','True Damage'])) {
            ...
            $status_effects = TableRegistry::getTableLocator()->get('Statuses')
                ...
                ->all()
                ->toList();
            $status_effects_list = ['random_buff' => 'a Random Buff','all_buffs' => 'All Buffs', 'random_debuff' => 'a Random Debuff', 'all_debuffs' => 'All Debuffs', 'random_buff_debuff' => 'a Random Buff or Debuff', 'all_buffs_debuffs' => 'All Buffs and Debuffs'];
